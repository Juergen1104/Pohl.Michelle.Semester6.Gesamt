...
public class PacMan extends GameEntity {
	...
	private void loadImages() {
		...
		//TODO: Code hier einfügen
		try {
			pacmanUpImage = ImageIO.read(new File("src/P3/resources/pacmanUp.png"));
			pacmanDownImage = ImageIO.read(new File("src/P3/resources/pacmanDown.png"));
			pacmanLeftImage = ImageIO.read(new File("src/P3/resources/pacmanLeft.png"));
			pacmanRightImage = ImageIO.read(new File("src/P3/resources/pacmanRight.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
