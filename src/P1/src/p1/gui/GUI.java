package P1.src.p1.gui;



import P1.src.p1.model.Song;
import P1.src.p1.utils.CSVReader;
import P1.src.p1.utils.DataFilter;
import P1.src.p1.xml.XMLReader;
import P1.src.p1.xml.XMLWriter;
import P1.src.p1.xml.XML_PushParser;
	...
	private Set<Integer> selectedSongIndices = new HashSet<>();
	    ...
	    public GUI() {
	        ...
	        try {
				...
				songs = reader.parseFile("src/P1/data/spotify_songs.csv");
	        } catch (IOException e) {
	    ...
	    private JPanel createXMLFilterPanel() {
	        ...
	        showButton.addActionListener(e -> {
	            ...
	            try {
	                ...
	                // **********
	                XML_PushParser parser = new XML_PushParser("src/P1/data/all_songs.xml",n);
	    ...
	    private void loadSongsIntoTableModel(DefaultTableModel tableModel) {
	        try {
	            CSVReader reader = new CSVReader();
				List<Song> songs = reader.parseFile("src/P1/data/spotify_songs.csv");
	            for (Song song : songs) {
	                tableModel.addRow(new Object[]{
	                        song.getTitle(),
	                        song.getArtist(),
